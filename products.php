...
<div id="main-wrapper">
    ...
    <div class="service-section section pt-80 pt-lg-60 pt-md-45 pt-sm-40 pt-xs-30 pb-50 pb-lg-30 pb-md-20 pb-sm-10 pb-xs-0">
        <div class="container">
           
            <div class="row">
                <div class="col">
                    <div class="section-title text-center mb-40 mb-lg-30 mb-md-30 mb-sm-30 mb-xs-30">
                        <h1>Products</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-service-item mb-30">
                        ...
                        <div class="service-content">
                            ...
                            <a class="more-btn" href="solar-street-lights.php">View<i class="fa fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <!--Single Service Item End-->
                </div>
